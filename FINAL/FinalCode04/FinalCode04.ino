...
void setup() {
  ...
  if(myVR.load((uint8_t)Consejo) >= 0){
    Serial.println("Comando Consejo leído");
  }
  ...
  if (ret > 0) {
    switch (buf[1]) {
      ...
      case Consejo:
        ...
        if(randNumber == 0) randNumber=23;        //Lavar los dientes 24
        else if(randNumber == 1) randNumber=22;   //Agua natural      23
        else if(randNumber == 2) randNumber=27;  //Alimentación      28 
        else if(randNumber == 3) randNumber=26;  //Ejercicio         27
        else if(randNumber == 4) randNumber=26;  //No te exongas sol 30
        else if(randNumber == 5) randNumber=32;   //Ordena juguetes   29
        else if(randNumber == 6) randNumber=39;   //Haz tarea         31
        //OJOS DE ZURI
        showWink();
        //delay(4000);
        myDFPlayer.volume(30);  
